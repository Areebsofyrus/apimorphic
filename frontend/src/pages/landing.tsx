...
export default function Landing({ onLoginSuccess }: LandingProps) {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col relative overflow-hidden pb-12">
      ...
      <header className="sticky top-0 z-40 w-full border-b border-slate-200/80 dark:border-slate-900 bg-white/70 dark:bg-slate-950/70 backdrop-blur-md px-4 md:px-6 py-3 md:py-4 flex items-center justify-between shadow-xs">
        ...
        <div className="flex items-center gap-3">
          <div className="flex flex-col items-center relative select-none pr-5 py-1">
            <APIMorphicLogo className="h-10 md:h-14 w-auto shrink-0 object-contain" />
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <Button
            ...
            className="text-xs font-semibold text-slate-650 hover:text-slate-900 dark:text-slate-350 dark:hover:text-white flex items-center gap-1.5 cursor-pointer rounded-lg h-9 px-2.5 sm:px-3"
          >
          ...
          <Button
            ...
            className="text-xs font-bold border-slate-200 hover:bg-slate-100 dark:border-slate-850 cursor-pointer rounded-lg flex items-center gap-1.5 h-9 px-2.5 sm:px-3"
          >
